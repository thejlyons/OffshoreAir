...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#name-tf'), $('#email-tf'), $('#pass-tf'), $('#pass-conf')];
	this.controlGroups = [$('#name-cg'), $('#email-cg'), $('#pass-cg'), $('#pass-match')];
...
// bind the form-error modal window to this controller to display any errors //
	...
	this.passwordsMatch = function(s, m) {
		return s == m;
	}
...
AccountValidator.prototype.validateForm = function()
{
	...
	if (this.passwordsMatch(this.formFields[2].val(), this.formFields[3].val()) == false) {
